...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 28, 2019 lúc 04:58 PM
...
CREATE TABLE `member` (
  ...
  `loai_tai_khoan` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member` (`id`, `ten`, `email`, `link_anh`, `ten_dang_nhap`, `mat_khau`, `loai_tai_khoan`) VALUES
(3, 'Phan Đức Quân', 'abc@gmail.com', 'http://asianwiki.com/images/e/e8/Song_Joong-Ki-p002.jpeg', 'quanquan', '$2b$10$vCwul6.utQZEyNMRSZqlEOBRuEAZtCzZvZ8PbiEywMBRnY9bL4m4S', 0),
(4, 'Phan Đức Quân', 'phanquan@gmail.com', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBxITEhUSExMVFRUXGBgXFxcWGBcVFxUXGhcXFxUYFxcYHSggGBolHRUVITEhJSkrLi4uFx8zODMtNygtLisBCgoKDg0OGxAQGy0lHyUtLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLf/AABEIAPoAyQMBEQACEQEDEQH/', 'phanquan', '$2b$10$LchK7eyUIJ/BPVJ8n1G9IuJjIzHz7.r0kdUMywSZetXZ7erawjubi', 0);
...
INSERT INTO `orders` (`id`, `tenkhachhang`, `madonhang`, `ngaydathang`, `thanhtoan`, `idTrangThai`) VALUES
(1, 'abcd', '', '0000-00-00', 0, 0),
(2, 'abcd', '', '0000-00-00', 0, 0);
